...
<section class="print-page space-y-8">
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <div class="no-print flex flex-wrap items-center gap-3">
            <a href="../actions/export_reports.php?from_date=<?= htmlspecialchars($fromDate) ?>&to_date=<?= htmlspecialchars($toDate) ?>"
                target="download-frame"
                data-no-smooth-nav="true"
                class="flex items-center gap-3 px-8 py-4 bg-green-600 text-white rounded-2xl font-black text-sm hover:bg-green-700 hover:-translate-y-1 active:scale-95 transition-all shadow-xl shadow-green-200">
